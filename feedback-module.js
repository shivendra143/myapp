...
/* harmony import */ var _feedbackinfo_feedbackinfo_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./feedbackinfo/feedbackinfo.component */ "./src/app/feedback/feedbackinfo/feedbackinfo.component.ts");
...
var routes = [
    {
        ...
        'children': [
            {
                'path': '',
                'component': _feedbackinfo_feedbackinfo_component__WEBPACK_IMPORTED_MODULE_2__["FeedbackinfoComponent"],
            }
        ],
    },
];
var FeedbackModule = /** @class */ (function () {
    ...
    FeedbackModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_feedbackinfo_feedbackinfo_component__WEBPACK_IMPORTED_MODULE_2__["FeedbackinfoComponent"]],
            providers: []
        })
    ], FeedbackModule);
...
/***/ "./src/app/feedback/feedbackinfo/feedbackinfo.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/feedback/feedbackinfo/feedbackinfo.component.html ***!
  \*******************************************************************/
...
/***/ "./src/app/feedback/feedbackinfo/feedbackinfo.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/feedback/feedbackinfo/feedbackinfo.component.ts ***!
  \*****************************************************************/
/*! exports provided: FeedbackinfoComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FeedbackinfoComponent", function() { return FeedbackinfoComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var FeedbackinfoComponent = /** @class */ (function () {
    function FeedbackinfoComponent() {
    }
    FeedbackinfoComponent.prototype.ngOnInit = function () {
    };
    FeedbackinfoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-feedbackinfo',
            template: __webpack_require__(/*! ./feedbackinfo.component.html */ "./src/app/feedback/feedbackinfo/feedbackinfo.component.html"),
            styles: [__webpack_require__(/*! ./feedbackinfo.component.scss */ "./src/app/feedback/feedbackinfo/feedbackinfo.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], FeedbackinfoComponent);
    return FeedbackinfoComponent;
}());
